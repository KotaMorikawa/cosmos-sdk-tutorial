...
// source: hello/nihao/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_39b6190828ab79df, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_39b6190828ab79df, []int{1}
}
...
func (*QueryGetTaskRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_39b6190828ab79df, []int{2}
}
...
func (*QueryGetTaskResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_39b6190828ab79df, []int{3}
}
...
func (*QueryAllTaskRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_39b6190828ab79df, []int{4}
}
...
func (*QueryAllTaskResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_39b6190828ab79df, []int{5}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "hello.nihao.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "hello.nihao.QueryParamsResponse")
	proto.RegisterType((*QueryGetTaskRequest)(nil), "hello.nihao.QueryGetTaskRequest")
	proto.RegisterType((*QueryGetTaskResponse)(nil), "hello.nihao.QueryGetTaskResponse")
	proto.RegisterType((*QueryAllTaskRequest)(nil), "hello.nihao.QueryAllTaskRequest")
	proto.RegisterType((*QueryAllTaskResponse)(nil), "hello.nihao.QueryAllTaskResponse")
}

func init() { proto.RegisterFile("hello/nihao/query.proto", fileDescriptor_39b6190828ab79df) }

var fileDescriptor_39b6190828ab79df = []byte{
	...
	,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hello.nihao.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Task(ctx context.Context, in *QueryGetTaskRequest, opts ...grpc.CallOption) (*QueryGetTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hello.nihao.Query/Task", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TaskAll(ctx context.Context, in *QueryAllTaskRequest, opts ...grpc.CallOption) (*QueryAllTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hello.nihao.Query/TaskAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.nihao.Query/Params",
	}
...
func _Query_Task_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.nihao.Query/Task",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_TaskAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.nihao.Query/TaskAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "hello/nihao/query.proto",
}
